...
func TestWrapStreamResultPreservesRetryAfterForCooldown(t *testing.T) {
	...
	result := m.wrapStreamResult(context.Background(), auth, "codex", "gpt-5.4-mini", "gpt-5.4-mini", nil, nil, remaining, OAuthModelAliasResult{}, false, cliproxyexecutor.Options{})
