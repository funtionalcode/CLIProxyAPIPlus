...
func (w *Watcher) reloadConfig() bool {
	...
	forceAuthRefresh := oldConfig != nil && (oldConfig.ForceModelPrefix != newConfig.ForceModelPrefix || !reflect.DeepEqual(oldConfig.OAuthModelAlias, newConfig.OAuthModelAlias) || !reflect.DeepEqual(oldConfig.OAuthAuthModelAlias, newConfig.OAuthAuthModelAlias) || retryConfigChanged)
