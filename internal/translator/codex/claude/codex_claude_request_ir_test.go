...
func TestConvertClaudeRequestToCodexIR_SystemMessageScenarios(t *testing.T) {
	tests := []struct {
		name             string
		inputJSON        string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ConvertClaudeRequestToCodexIR("test-model", []byte(tt.inputJSON), false)
			if result == nil {
				t.Fatal("ConvertClaudeRequestToCodexIR returned nil")
			}
...
func TestConvertClaudeRequestToCodexIR_ParallelToolCalls(t *testing.T) {
	tests := []struct {
		name                  string
		inputJSON             string
...
func TestConvertClaudeRequestToCodexIR_ShortenLongToolUseIDs(t *testing.T) {
	...
	result := ConvertClaudeRequestToCodexIR("test-model", []byte(inputJSON), false)
	if result == nil {
		t.Fatal("ConvertClaudeRequestToCodexIR returned nil")
	}
...
func TestConvertClaudeRequestToCodexIR_ToolChoiceModeMapping(t *testing.T) {
	tests := []struct {
		name                string
...
func TestConvertClaudeRequestToCodexIR_ToolChoiceSpecificFunctionUsesConvertedName(t *testing.T) {
...
func TestConvertClaudeRequestToCodexIR_WebSearchToolMapping(t *testing.T) {
	inputJSON := `{
		"model": "claude-3-opus",
		"tools": [
			{
	...
	// Note: The IR tool format doesn't carry filters/user_location for web_search tools.
	// The IR parser stores them in the tool's passthrough or drops them.
	// For now, we verify the type mapping works.
}

func TestConvertClaudeRequestToCodexIR_WebSearchToolChoiceUsesDeclaredTypedToolName(t *testing.T) {
	inputJSON := `{
...
func TestConvertClaudeRequestToCodexIR_AssistantThinkingSignatureToReasoningItem(t *testing.T) {
...
func TestConvertClaudeRequestToCodexIR_IgnoresNonCodexThinkingSignatures(t *testing.T) {
	tests := []struct {
		name      string
		inputJSON string
	}{
